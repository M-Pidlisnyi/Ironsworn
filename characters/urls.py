...
urlpatterns = [
    ...
    path('<int:char_id>/quest/<int:pk>/finish/', views.FinishQuestView.as_view(), name="finish-quest"),
    ...
    path('<int:char_id>/vow/<int:pk>/fulfill/', views.fulfill_vow, name="fulfill-vow"),
